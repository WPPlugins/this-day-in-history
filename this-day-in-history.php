...
function tdih_add_menu() {
	...
	$tdih_events = add_menu_page(__('This Day In History', 'this-day-in-history'), __('Historic Events', 'this-day-in-history'), 'manage_tdih_events', 'this-day-in-history', 'tdih_events', 'dashicons-backup');
...
function tdih_screen_options () {
	...
	$content .= '<ul>';
	$content .= '<li>'.__('show_type (1 or 0) - 1 shows event types (default) and 0 does not.', 'this-day-in-history').'</li>';
	$content .= '<li>'.__('show_date (1 or 0) - 1 shows the date of the event (default) and 0 does not.', 'this-day-in-history').'</li>';
	$content .= '<li>'.__('show_head (1 or 0) - 1 shows a header row (default) and 0 does not.', 'this-day-in-history').'</li>';
